...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            $query = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total FROM biaya WHERE id_jurusan IS NULL OR id_jurusan = '$id_jurusan'");
            ...
            <div class="card-body">
                <div class="table-responsiv">
                    <table class="table table-striped table-sm" id="table-1">
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($koneksi, "select * from biaya WHERE id_jurusan IS NULL OR id_jurusan = '$id_jurusan'");
                            $no = 0;
