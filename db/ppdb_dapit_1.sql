...
INSERT INTO `bayar` (`id_bayar`, `id_user`, `id_daftar`, `jumlah`, `tgl_bayar`, `keterangan`, `bukti`, `verifikasi`, `hapus`, `jenis_bayar`) VALUES
	...
	('202505240001', 0, 316, 50000, '2025-05-24', NULL, 'bukti_transaksi/bukti_202505240001.png', 1, NULL, 'ppdb'),
	('202505240002', 0, 316, 200000, '2025-05-24', NULL, 'bukti_transaksi/bukti_202505240002.png', 1, NULL, 'ppdb'),
...
INSERT INTO `formulir` (`id`, `no_pendaftaran`, `no_daftar`, `kategori`, `nama_siswa`, `nomor_induk`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `anak_ke`, `jumlah_saudara`, `status_keluarga`, `alamat_rumah`, `alamat_sekarang`, `kelas_diterima`, `tanggal_diterima`, `sekolah_asal`, `alamat_sekolah_asal`, `sttb_tahun`, `sttb_nomor`, `nama_ayah`, `nama_ibu`, `agama_ortu`, `alamat_ortu`, `pekerjaan_ayah`, `pekerjaan_ibu`, `pendidikan_ayah`, `pendidikan_ibu`, `penghasilan`, `nama_wali`, `agama_wali`, `alamat_wali`, `pendidikan_wali`, `pekerjaan_wali`) VALUES
	...
	(24, 'PSB-4', '320', '1', 'Maman macan', '12938832832392', 'Laki-laki', 'Tokyo', '2031-04-09', 1, 2, 'Anak', 'Desa manonjaya, kec.Manonjaya, Kab,Tasikmalaya, Prov.Jawa Barat', 'Desa manonjaya, kec.Manonjaya, Kab,Tasikmalaya, Prov.Jawa Barat', '1', '2035-07-03', 'Fuji Yochien', 'Jepang', '2033', '923823293232323', 'Dedi kusnandar', 'Mizuhara', 'Islam', 'Desa manonjaya, kec.Manonjaya, Kab,Tasikmalaya, Prov.Jawa Barat', 'Guru/Dosen', 'Dokter', 'Diploma I/II', 'S1 (Sarjana)', 'Rp.3.000.001 s/d Rp.5.000.000', 'Dedi kusnandar', 'Islam', 'Desa manonjaya, kec.Manonjaya, Kab,Tasikmalaya, Prov.Jawa Barat', 'Diploma I/II', 'Guru/Dosen'),
	...
	(29, 'PSB-9', '324', '1', 'anu', '128238232322', 'Laki-laki', 'Bandung', '2292-02-02', 3, 4, 'Anak', 'jln.contoh no 10', 'jln.contoh no 10', NULL, NULL, 'ksadksakd', 'Jepang', '2033', '923823293232323', 'Dedi kusnandar', 'Mizuhara', 'Islam', 'jln.contoh no 10', 'Politikus', 'Politikus', 'S2 (Magister)', 'S1 (Sarjana)', 'Lebih dari Rp.5.000.001', 'Mizuhara', 'Islam', 'jln.contoh no 10', 'S1 (Sarjana)', 'Politikus'),
	(31, 'PSB-10', '325', '1', 'Anu Kusnandar', '1929293239292', 'Laki-laki', 'Tokyo', '2025-06-22', 1, 1, 'Anak', 'jln.contoh no 10', 'jln.contoh no 10', NULL, NULL, 'Fuji Yochien', 'Jepang', '2033', '923823293232323', 'Dedi kusnandar', 'Mizuhara Hosi', 'Islam', 'jln.contoh no 10', 'Guru/Dosen', 'TNI/POLRI', 'Diploma I/II', 'Diploma III/IV', 'Rp.3.000.001 s/d Rp.5.000.000', 'Mizuhara Hosi', 'Islam', 'jln.contoh no 10', 'Diploma III/IV', 'TNI/POLRI'),
	(32, 'PSB-11', '326', '1', 'Jojon susi', '123283728323923', 'Laki-laki', 'Tasikmalaya', '2025-06-22', 1, 1, 'anak', 'jln.contoh no 10', 'jln.contoh no 10', NULL, NULL, 'Fuji Yochien', 'Jepang', '2033', '923823293232323', 'Dedi kusnandar', 'Mizuhara osisi', 'Islam', 'jln.contoh no 10', 'Politikus', 'Lainnya', 'S3 (Doktor)', 'S1 (Sarjana)', 'Lebih dari Rp.5.000.001', 'Mizuhara osisi', 'Islam', 'jln.contoh no 10', 'S1 (Sarjana)', 'Lainnya');
