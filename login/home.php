<div class="row">
    ...
    <div class="col-lg-3">
        <div class="small-box bg-blue">
            ...
            <a href="?pg=daftar" class="small-box-footer">
    ...
    <div class="col-lg-3">
        <div class="small-box bg-red">
            ...
            <a href="?pg=jurusan" class="small-box-footer">
                More info <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
    </div>
...
<div style="float:right; margin-top:-220px">
    ...
    <button class="btn btn-flat bg-red">
        ...
        <span id="timestamp" style="font-family:'OCR A Extended'"><?= date('h:i:s') ?></span>
    </button>
</div>
                ...
                <ul class="nav nav-tabs" id="myTab5" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab5" data-toggle="tab" href="#profile5" role="tab" aria-controls="profile" aria-selected="false">
                            <i class="fas fa-id-card"></i> Alamat Lembaga
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="kepala-tab5" data-toggle="tab" href="#kepala5" role="tab" aria-controls="kepala" aria-selected="false">
                            <i class="fas fa-user"></i> Kepala Madrasah
                        </a>
                    </li>
                </ul>
