				...
				<div class='box box-solid'>
					<div class='box-header'>
						...
						<div class='box-tools pull-right btn-group'>
							<a class="btn btn-primary" href="mod_laporan/print_daftar_ditolak.php" role="button"> Cetak</a>
						</div>
					</div>
						...
						<div class='table-responsive'>
							<div style='background:#fff; width:80%; margin:0 auto; padding:35px; height:90%;'>
								...
								<table border='0' width='95%' align='center'>
									<tr height='30'>
										<td height='30' colspan='4' style='text-align: justify;'>Data Siswa Baru Yang ditolak Tahun Pelajaran <b> <?= $tahunAktif['tahun'] ?></b> pada madrasah <b><?= $setting['nama_sekolah'] ?></b></td>
									</tr>
								</table>
								<br>
