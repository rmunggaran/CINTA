	...
	<font face="arial">
		...
		<div style='background:#fff; width:100%; margin:0 auto; padding:1px; height:10%;'>
			...
			<table border='0' width='95%' align='center'>
				<tr height='30'>
					<td height='30' colspan='4' style='text-align: justify;'>Data Siswa Baru Yang diterima Tahun Pelajaran <b> <?= $setting['tahun_ajaran'] ?></b> pada madrasah <b><?= $setting['nama_sekolah'] ?></b></td>
				</tr>
			</table>
			<br>
