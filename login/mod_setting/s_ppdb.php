                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-header-action">
                                                <select id="selectJurusan" class="form-control">
                                                ...
                                                <div id="totalBiaya"><b>Total Biaya: Rp. 0</b></div>

                                                <script>
                                                    document.getElementById('selectJurusan').addEventListener('change', function() {
                                                        var idJurusan = this.value;

                                                        // Kirim AJAX ke file PHP handler
                                                        fetch('mod_biaya/get_total_biaya.php', {
                                                                method: 'POST',
                                                                headers: {
                                                                    'Content-Type': 'application/x-www-form-urlencoded'
                                                                },
                                                                body: 'id_jurusan=' + idJurusan
                                                            })
                                                            .then(response => response.text())
                                                            .then(data => {
                                                                document.getElementById('totalBiaya').innerHTML = data;
                                                            });
                                                    });
                                                </script>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-editbiaya<?= $no ?>">
                                                                        Edit
                                                                    </button>

                                                                    <!-- Modal -->
                                                                    <div class="modal fade" id="modal-editbiaya<?= $no ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <form id="form-edit<?= $no ?>">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Jurusan</label>
                                                                                            <select id="id_jurusan<?= $no ?>" name="id_jurusan" class="form-control">
                                                                                                <option value="">Umum (Semua Jurusan)</option>
                                                                                                <?php
                                                                                                $q = mysqli_query($koneksi, "SELECT * FROM jurusan");
                                                                                                while ($jur = mysqli_fetch_array($q)) {
                                                                                                    $selected = ($jur['id_jurusan'] == $biaya['id_jurusan']) ? 'selected' : '';
                                                                                                    echo "<option value='{$jur['id_jurusan']}' $selected>{$jur['nama_jurusan']}</option>";
                                                                                                }
                                                                                                ?>
                                                                                            </select>
                                                                                        </div>
