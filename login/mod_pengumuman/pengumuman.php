...
<section class="section">
    ...
    <div class="section-header">
        ...
        <!-- Modal -->
        <div class="modal fade backdrop" id="tambahdata" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    <label class="selectgroup-item">
                                        <input type="radio" name="jenis" value="0" class="selectgroup-input" checked="">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped" id="table-1">
                            ...
                            <tbody>
                                <?php
                                $query = mysqli_query($koneksi, "select * from pengumuman ORDER BY tgl DESC");
                                $no = 0;
                                                        ...
                                                        <form id="form-edit<?= $no ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="selectgroup w-100">
                                                                        <label class="selectgroup-item">
                                                                            <input type="radio" name="jenis" value="0" class="selectgroup-input" <?= $pengumuman['jenis'] == 0 ? 'checked' : '' ?>>
                                                                            <span class="selectgroup-button">Semua</span>
                                                                        </label>
                                                                        <label class="selectgroup-item">
                                                                            <input type="radio" name="jenis" value="1" class="selectgroup-input" <?= $pengumuman['jenis'] == 1 ? 'checked' : '' ?>>
                                                                            <span class="selectgroup-button">Internal</span>
                                                                        </label>
                                                                        <label class="selectgroup-item">
                                                                            <input type="radio" name="jenis" value="2" class="selectgroup-input" <?= $pengumuman['jenis'] == 2 ? 'checked' : '' ?>>
                                                                            <span class="selectgroup-button">Eksternal</span>
                                                                        </label>
                                                                    </div>
                                                                </div>
