                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="card card-login bg-success">
                                ...
                                <div class="card-body">
                                    <img src="<?= $setting['logo_ppdb'] ?>" alt="" width="40%" style="display: block; margin-left: auto; margin-right: auto;">
                                    <br>
                                    <form id="form-login">
                                        <div class="form-group">
                                            <span class="fa fa-user"></span>
                                            <input type="text" onkeyup="this.value = this.value.toUpperCase()" class="form-control" name="username" placeholder="Masukkan NISN atau Nama" required autocomplete="off">
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p align="center">
                                    <img src="assets/alurppdbmic.png" align="center" width="500" style="max-width: 100%" />
                                </p>
                                        ...
                                        <div class="row">
                                            <div class="col-12 animated bounceIn">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="activities">
                                                            <?php $query = mysqli_query($koneksi, "SELECT * FROM pengumuman where jenis IN (0, 2) ORDER BY tgl DESC LIMIT 1");
